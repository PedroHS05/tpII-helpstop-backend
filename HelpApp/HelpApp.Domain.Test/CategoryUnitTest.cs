...
namespace HelpApp.Domain.Test
{
    public class CategoryUnitTest
    {
        ...
        {
            Action action = () => new Category(-1, "");
            action.Should().Throw<HelpApp.Domain.Validation.DomainExceptionValidation>().WithMessage("Invalid Id value.");
        }

        [Fact(DisplayName = " Create Category With To Short")]
        public void CreateCategory_WithToShort_ResultObjectException()
        {
